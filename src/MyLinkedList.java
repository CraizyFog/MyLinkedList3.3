...
public class MyLinkedList <E> {
    ...
    public void add(E e) {
        if (size != 0) {
            Element<E> elementNew = new Element<>(e, null, last);
    ...
    public void add(int index, E element) {
        ...
        if (index == 0) {
            ...
            Element<E> newElement = new Element<>(element, elementAfter, elementBefore);
    ...
    public void addFirst(E e) {
        Element<E> newElement = new Element<>(e, first, null);
        first.setPrev(newElement);
        first = newElement;
        size++;
    }
    public void addLast(E e) {;
        Element<E> newElement = new Element<>(e, null, last);
    ...
    public E get(int index){
        ...
        //return receivedElement.getElement();
    }
    public E getFirst() {
        checkElement(first);
